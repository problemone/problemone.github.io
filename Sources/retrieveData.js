...
function initializeWebsite(){
    ...
    window.addEventListener('scroll', () => {
        ...
        let colorScale = 170;
        bodyElement.style.backgroundColor = "rgb(" + Math.min(percScroll * colorScale + backgroundMinColor[0], backgroundMinColor[0] + colorScale) + "," + Math.min(percScroll * colorScale + backgroundMinColor[1], backgroundMinColor[1] + colorScale) + "," +  Math.min(percScroll * colorScale + backgroundMinColor[2], backgroundMinColor[2] + colorScale) + ")";
    });
